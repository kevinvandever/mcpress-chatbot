  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.token) {
        // Subscription verified — redirect to reset password with token
      ...
      switch (response.status) {
        case 403:
          ...
          break;
        case 404:
          setError(data.error || 'No password set for this account. Please log in to create one.');
          break;
        case 429:
          setError('Too many reset requests. Please try again later.');
          break;
        case 503:
          setError(data.error || 'Service temporarily unavailable. Please try again later.');
          break;
        default:
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-2xl shadow-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Enter your subscription email to verify your identity and reset your password.
          </p>
        </div>
